...
startupSound.SoundId = "rbxassetid://6679600554"
startupSound.Volume = 9 -- Điều chỉnh âm lượng nếu cần
...
local Window = Library:CreateWindow{
    Title = "Nhân Dz",
    SubTitle = "Đuợc tạo bởi Chat Gpt",
    TabWidth = 160,
...
toggleButton.Image = "rbxassetid://138418640790242" -- Hình ảnh của nút
